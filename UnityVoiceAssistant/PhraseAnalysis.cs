...
{
    //Method counts how many items does a given string contain from a given array of strings
    ...
    //Method applies GetMatches to every item from the Keywords and returns an ID, or -1 if no matches, or -2 if empty or invalid string
